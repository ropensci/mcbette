...
```{r}
inference_model_1 <- mcbette::create_ns_inference_model()
...
An Bayesian phylogenetic inference model consist of, among others,
a site, clock and tree model. 
...
The `beautier` package supplies the site, clock and tree models.
...
As an example, to use the HKY site model:
