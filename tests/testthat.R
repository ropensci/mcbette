...
is_beast2_ns_pkg_installed_before <- NA
if (is_beast2_installed_before) {
  is_beast2_ns_pkg_installed_before <- mauricer::is_beast2_ns_pkg_installed()
}

test_check("mcbette")

is_beast2_installed_after <- beastier::is_beast2_installed()
is_beast2_ns_pkg_installed_after <- NA
if (is_beast2_installed_before) {
  is_beast2_ns_pkg_installed_after <- mauricer::is_beast2_ns_pkg_installed()
}
